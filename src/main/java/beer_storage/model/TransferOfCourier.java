...
@Entity
@Table(name = "transfers_of_courier")
public class TransferOfCourier {
    ...
    public TransferOfCourier() {
    }

    public TransferOfCourier(Long id, LocalDateTime time, Map<Product, Integer> products, Courier courier) {
        this.id = id;
        this.time = time;
